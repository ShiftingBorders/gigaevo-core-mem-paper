"""
Validation function for: Heilbronn Triangle Problem for Convex Regions - optimal placement of 14 points to maximize minimum triangle area
"""
...
def validate(points):
    ...
    Args:
        points: (14, 2) array from entrypoint()

    Returns:
        dict with metrics:
        - min_area_normalized: Area of smallest triangle divided by convex hull area (PRIMARY OBJECTIVE - maximize)
        - combined_score: Progress toward benchmark: min_area_normalized / 0.027835571458482138 (PRIMARY OBJECTIVE - maximize, > 1 means new record)
