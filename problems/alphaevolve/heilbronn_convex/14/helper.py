"""
Helper functions for: Heilbronn Triangle Problem for Convex Regions - optimal placement of 14 points to maximize minimum triangle area
...
def validate_points(points: np.ndarray, num_points: int = 14) -> None:
